...
public class level10 : MonoBehaviour {
	...
	private static float timeforeachquestion =40; // this is the total time for this level
	...
	void Start (){
		...
		PlayerPrefs.SetInt ("RecentLevel", 10);
		PlayerPrefs.Save ();
	...
	void stopgame(){
		...
		PlayerPrefs.SetInt ("level10score", correctanswers);
		PlayerPrefs.Save ();
	...
	void givestars(){
		...
		if (correctanswers == 20) {
			...
			int previousstars = PlayerPrefs.GetInt("level10stars",0);
