...
public class level9 : MonoBehaviour {
	...
	private static float timeforeachquestion = 20f;
	...
	void Start (){
		...
		PlayerPrefs.SetInt ("RecentLevel", 9);
		PlayerPrefs.Save ();
	...
	void stopgame(){
		...
		PlayerPrefs.SetInt ("level9score", correctanswers);
		PlayerPrefs.Save ();
	...
	void givestars(){
		...
		if (correctanswers == 20) {
			...
			int previousstars = PlayerPrefs.GetInt("level9stars",0);
