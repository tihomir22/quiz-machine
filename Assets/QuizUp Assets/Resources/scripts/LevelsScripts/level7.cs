...
public class level7 : MonoBehaviour {
	...
	void Start (){
		...
		PlayerPrefs.SetInt ("RecentLevel", 7);
		PlayerPrefs.Save ();
	...
	void stopgame(){
		...
		PlayerPrefs.SetInt ("level7score", correctanswers);
		PlayerPrefs.Save ();
	...
	void givestars(){
		...
		if (correctanswers == 18) {
			...
			int previousstars = PlayerPrefs.GetInt("level7stars",0);
