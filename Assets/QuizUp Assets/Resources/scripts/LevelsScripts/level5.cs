...
public class level5 : MonoBehaviour {
	...
	void Start (){
		...
		PlayerPrefs.SetInt ("RecentLevel", 5);
		PlayerPrefs.Save ();
	...
	void stopgame(){
		...
		PlayerPrefs.SetInt ("level5score", correctanswers);
		PlayerPrefs.Save ();
	...
	void givestars(){
		...
		if (correctanswers >= 13 && correctanswers <= 15) {
			...
			int previousstars = PlayerPrefs.GetInt("level5stars",0);
		...
		if (correctanswers >= 16 && correctanswers <= 18) {
